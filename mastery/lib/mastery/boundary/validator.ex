defmodule Mastery.Boundary.Validator do
  ...
  defp check_required_field(true = _present, fields, errors, field_name,
      _valdiator_fn = f) do
    valid = fields |> Map.fetch!(field_name) |> f.()
    check_field(valid, errors, field_name)
  end
  defp check_required_field(_present, _field, errors, field_name, _f) do
