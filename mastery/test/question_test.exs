defmodule Mastery.QuestionTest do
  ...
  test "building creates the asked question text" do
    question = build_question(generators: addition_generators([1], [2]))

    assert question.asked == "1 + 2"
  end

  test "a random choice is made from list of generators" do
    generators = addition_generators(Enum.to_list(0..9), [0])
