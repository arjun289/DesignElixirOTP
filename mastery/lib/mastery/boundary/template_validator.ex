defmodule Mastery.Boundary.TemplateValdiator do
  ...
  def validate_name(_field), do: {:error, "must be an atom"}
  ...
  def validate_checker(_checker), do: {:error, "must be a function with arity 2"}
